...
<div id="main_container">
	...
	<div id="header">
        ...
        <div id="logo">
            <a href="index.jsp"><img src="Images/logo.png" alt="" title="" border="0" width="237" height="140" /></a>
	    </div>
        	...
        	<div class="oferta">
           		...
           		<div class="oferta_content">
                    ...
                    <div class="oferta_details">
                            ...
                            <a href="WebActions/details.jsp" class="details">details</a>
                    </div>
                </div>
   ...
   <div id="main_content"> 
            ...
            <div class="left_menu_corner"></div>
                    <ul class="menu">
                         ...
                         <li class="divider"></li>
                         <li><a href="WebActions/contact.jsp" class="nav6">Contact Us</a></li>
                         <li class="divider"></li>
   ...
   <div class="left_content">
    <div class="title_box">Categories</div>
        ...
        <ul class="left_menu">
        <li class="odd"><a href="WebActions/services.jsp">Processors</a></li>
        <li class="even"><a href="WebActions/services.jsp">Motherboards</a></li>
         <li class="odd"><a href="WebActions/services.jsp">Desktops</a></li>
        <li class="even"><a href="WebActions/services.jsp">Laptops & Notebooks</a></li>
         <li class="odd"><a href="WebActions/services.jsp">Processors</a></li>
         <li class="even"><a href="WebActions/services.jsp">Motherboards</a></li>
        <li class="odd"><a href="WebActions/services.jsp">Processors</a></li>
        <li class="even"><a href="WebActions/services.jspservices.html">Motherboards</a></li>
         <li class="odd"><a href="WebActions/services.jsp">Desktops</a></li>
        <li class="even"><a href="WebActions/services.jsp">Laptops & Notebooks</a></li>
         <li class="odd"><a href="WebActions/services.jsp">Processors</a></li>
         <li class="even"><a href="WebActions/services.jsp">Motherboards</a></li>
     ...
     <div class="border_box">
         ...
         <div class="product_img"><a href="WebActions/details.jsp"><img src="Images/laptop.png" alt="" title="" border="0" /></a></div>
   	...
   	<div class="center_title_bar">Latest Products</div>
    	...
    	<div class="prod_box">
            ...
            <div class="center_prod_box">            
                 <div class="product_title"><a href="WebActions/details.jsp">Motorola 156 MX-VL</a></div>
                 <div class="product_img"><a href="WebActions/details.jsp"><img src="Images/laptop.gif" alt="" title="" border="0" /></a></div>
                 <div class="prod_price"><span class="reduce">350$</span> <span class="price">270$</span></div>                        
            </div>
            ...
            <a href="WebActions/details.jsp" class="prod_details">details</a>            
            </div>                     
        </div>
     	...
     	<div class="prod_box">
            ...
            <div class="center_prod_box">            
                 ...
                 <div class="product_img"><a href="WebActions/details.jsp"><img src="Images/p4.gif" alt="" title="" border="0" /></a></div>
     	...
     	<div class="prod_box">
            ...
            <div class="center_prod_box">            
                 ...
                 <div class="product_img"><a href="WebActions/details.jsp"><img src="Images/p5.gif" alt="" title="" border="0" /></a></div>
                 <div class="prod_price"><span class="reduce">350$</span> <span class="price">270$</span></div>                        
            </div>
            <div class="bottom_prod_box"></div>             
            <div class="prod_details_tab">
 ...
 <div class="center_title_bar">Recommended Products</div>
   ...
   <div class="right_content">
     ...
     <div class="border_box">
         <div class="product_title"><a href="WebActions/details.jsp">Motorola 156 MX-VL</a></div>
         <div class="product_img"><a href="WebActions/details.jsp"><img src="Images/p2.gif" alt="" title="" border="0" /></a></div>
         <div class="prod_price"><span class="reduce">350$</span> <span class="price">270$</span></div>
     </div>  
    ...
    <div class="title_box">Manufacturers</div>
        ...
        <ul class="left_menu">
        <li class="odd"><a href="WebActions/services.jsp">Sony</a></li>
        <li class="even"><a href="WebActions/services.jsp">Samsung</a></li>
         <li class="odd"><a href="WebActions/services.jsp">Daewoo</a></li>
        <li class="even"><a href="WebActions/services.jsp">LG</a></li>
         <li class="odd"><a href="WebActions/services.jsp">Fujitsu Siemens</a></li>
         <li class="even"><a href="WebActions/services.jsp">Motorola</a></li>
        <li class="odd"><a href="WebActions/services.jsp">Phillips</a></li>
        <li class="even"><a href="WebActions/services.jsp">Beko</a></li>
        </ul>      
