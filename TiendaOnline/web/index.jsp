        ...
        <div id="main_container">
            ...
            <div id="main_content"> 
                ...
                <div class="center_content">
                    <div class="center_title_bar">Bienvenido a Electronix Store</div>
                    ...
                    <div class="prod_box_big">
                        ...
                        <div class="center_prod_box_big">            
                            <br>¡¡¡Bienvenido!!!<br>
                            <br>
                            <br>Esta es la web de Electronix Store: la mejor electrónica online<br>
                            <br>Puedes empezar a comprar directamente o echarle un vistazo a nuestros
